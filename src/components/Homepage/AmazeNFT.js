      ...
      <div className="flex md:flex-row flex-col items-center gap-10 lg:justify-between container mx-auto">
        ...
        <div className="flex lg:flex-row flex-col gap-6 lg:gap-14">
          ...
          >
            ...
            <div>
              <h4 className="text-xl font-bold">Fast Transaction</h4>
              <p className="text-[#696969] text-sm w-60 mt-2 leading-[160%]">
          ...
          >
            ...
            <div>
              <h4 className="text-xl font-bold">Growth Transaction</h4>
              <p className="text-[#696969] text-sm w-60 mt-2 leading-[160%]">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam
